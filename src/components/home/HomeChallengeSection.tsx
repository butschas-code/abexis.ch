          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-10">
            <div>
              ...
              <p className="mt-2.5 text-[16px] font-normal leading-[1.6] text-[#1d1d1f]">
                {c.whatIsMissing.line}
              </p>
              <p className="mt-1 text-[15px] leading-relaxed text-[#6e6e73]">{c.whatIsMissing.sub}</p>
            </div>
              ...
              <ul className="mt-2.5 list-none space-y-2 pl-0" role="list">
                {c.whenExternal.bullets.map((b) => (
                  <li key={b} className={`flex gap-2.5 ${body}`}>
                    <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-brand-900" aria-hidden />
                    {b}
                  </li>
                ))}
              </ul>
            ...
            <p className="border-l-2 border-brand-900/30 pl-4 text-[16px] font-normal leading-[1.6] text-[#1d1d1f] sm:col-span-2 sm:pl-5 lg:col-span-1">
              {c.framing}
            </p>
          </div>
        </div>
