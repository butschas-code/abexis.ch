...
const prcCopyEn = {
  ...
  dimensionen: [
    {
      key: "Strategy",
      label: "Strategy",
      body: "Are objectives, scope and success criteria clearly defined and supported by management?",
    },
    {
      key: "Governance",
      label: "Governance",
      body: "Do decision paths, escalation routes and project oversight work reliably?",
    },
    {
      key: "Execution",
      label: "Execution",
      body: "How realistic are the plan, resources and delivery capability of the team?",
    },
    {
      key: "Risks",
      label: "Risks",
      body: "Which risks are known, underestimated or not yet captured?",
    },
    {
      key: "Change",
      label: "Change",
      body: "Are stakeholders involved and is the organization ready for the change?",
    },
    {
      key: "Technology",
      label: "Technology",
      body: "Are technical decisions and dependencies robust and documented?",
    },
  ] as const,
  lieferobjekte: [
    { id: "exec", title: "Executive Summary", sub: "Management and board ready" },
    { id: "ampel", title: "Traffic-light assessment", sub: "Green / Yellow / Red per dimension" },
    { id: "risiken", title: "Top 10 risks", sub: "including probability" },
    { id: "governance", title: "Governance assessment", sub: "Structures, roles and decision paths" },
    { id: "change", title: "Change readiness assessment", sub: "Organizational assessment" },
    { id: "plan", title: "Concrete action plan", sub: "30 / 60 / 90 days" },
    { id: "empfehlung", title: "Clear recommendation", sub: "Continue · Stabilize · Reset" },
  ] as const,
  empfehlungen: [
    {
      key: "continue",
      ...
      barClass: "from-[#45b3e2]/70",
      title: "Continue",
      body: "The project is fundamentally on track. Identified points are addressed with targeted measures.",
    },
    {
      key: "stabilize",
      titleClass: "text-[#e8d4a8]",
      barClass: "from-[#c9a96e]/80",
      title: "Stabilize",
      body: "Significant risks require immediate action before the project moves into the next phase.",
    },
    {
      key: "reset",
      titleClass: "text-[#fecaca]",
      barClass: "from-[#f0a8a8]/75",
      title: "Reset",
      body: "Core assumptions or structures must be revised. A controlled restart is recommended.",
    },
  ] as const,
  prcPipelinePhasen: [
    {
      name: "Light",
      tagline: "Quick status assessment",
      dauer: "3-5 days",
      ziel: "Initial clarity",
      inhalt: [
        "Interviews with 3-5 key people",
        "High-level analysis across 6 dimensions",
        "Initial risk assessment",
      ],
      output: ["Short assessment", "Top 3-5 critical points", "Initial recommendations"],
    },
    {
      name: "Core",
      tagline: "Management clarity",
      dauer: "1-2 weeks",
      ziel: "Decision basis for management",
      inhalt: [
    ...
    {
      name: "Deep Dive",
      tagline: "Stabilization and direction",
      dauer: "3-4 weeks",
      ziel: "Basis for turnaround or realignment",
      inhalt: [
        "In-depth analysis",
  ...
  strings: {
    heroEyebrow: "Project Reality Check",
    heroTitle1: "Projects rarely fail outright",
    ...
    warningHeadline: "6 warning signs that a project is becoming critical.",
    warningIntro: "If 2 to 3 of these are visible, a closer look is worthwhile.",
    warningCta: "Schedule a call now",
    infographicAlt:
      "Why projects rarely fail outright but often drift: overview of typical patterns and when an external view helps",
    challengeLabel: "Challenge",
    challengeHeadline: "Many projects appear stable, but do not deliver the expected impact.",
    challengeBody: "Meetings take place, status reports look good, and still uncertainty emerges.",
    frequentlySeen: "What we often see",
    resultLabel: "Result",
    resultHeadline: "The result can be used immediately.",
    youReceive: "You receive",
    resultClosing: "So you know what needs to be done and what happens if nothing happens.",
    approachLabel: "Approach",
    approachHeadline: "Clarity instead of assumptions",
    approachBody:
    ...
    approachEmphasis: "So it becomes visible where your project really stands.",
    methodLabel: "Abexis 6 dimensions: methodology",
    methodBody:
    ...
    deliverablesHeadline: "What you receive specifically",
    deliverablesBody: "Clearly structured, suitable for management and board use, condensed to what matters.",
    dimensionsAlt: "Abexis 6 dimensions model: Strategy, Governance, Execution, Risks, Organisation & Change, Technology & Data",
    ...
    timelineLabel: "Example process: Core phase",
    timelineAlt:
      "Project Reality Check process: day 1 kickoff and document analysis, day 2-3 interviews, day 4 analysis and assessment, day 5 executive presentation",
    phaseLabel: "Phase",
    ...
    appointmentCta: "Schedule a call",
    nextStep: "Next step",
    finalHeadline: "Let us take a brief look at it",
    finalBody:
    ...
    tags: ["Free", "Short conversation", "Non-binding", "Modular"],
    calendarCta: "Open online calendar",
  },
};
...
export function ProjectFitCheck({ locale = "de" }: { locale?: "de" | "en" }) {
  ...
  const c = isEnglish
    ...
    : {
        ...
        strings: {
          heroEyebrow: "Project Reality Check",
          heroTitle1: "Projekte laufen selten falsch",
          heroTitle2: "aber oft in die falsche Richtung",
          heroBody:
            "Der Abexis Project Reality Check zeigt in kurzer Zeit, wo Ihr Projekt wirklich steht und was jetzt entschieden werden muss.",
          contactHref: "/kontakt",
          contactCta: "Unverbindlichen Termin vereinbaren",
          flowCta: "Ablauf ansehen",
          earlyWarning: "Früherkennung",
          warningHeadline: "6 Warnsignale, dass ein Projekt kritisch wird.",
          warningIntro: "Wenn 2 bis 3 davon erkennbar sind, lohnt sich ein genauer Blick.",
          warningCta: "Jetzt Termin vereinbaren",
          infographicAlt:
            "Warum Projekte selten scheitern aber oft entgleisen : Übersicht der typischen Muster und wann ein externer Blick hilft",
          challengeLabel: "Herausforderung",
          challengeHeadline: "Viele Projekte wirken stabil, liefern aber nicht den erwarteten Impact.",
          challengeBody: "Meetings finden statt, Statusberichte sehen gut aus : und trotzdem entsteht Unsicherheit.",
          frequentlySeen: "Was wir häufig sehen",
          resultLabel: "Ergebnis",
          resultHeadline: "Das Ergebnis ist sofort nutzbar.",
          youReceive: "Sie erhalten",
          resultClosing: "Damit Sie wissen, was zu tun ist : und was passiert, wenn nichts passiert.",
          approachLabel: "Ansatz",
          approachHeadline: "Klarheit statt Vermutung",
          approachBody:
            "Der Project Reality Check ist eine kurze, unabhängige Analyse auf Management-Ebene : ein strukturierter Reality Check mit Fokus auf Entscheidungen, Risiken und Steuerbarkeit.",
          approachEmphasis: "Damit sichtbar wird, wo Ihr Projekt wirklich steht.",
          methodLabel: "Abexis 6 Dimensionen : Methodik",
          methodBody:
            "Jede Dimension wird mit einer Ampelbewertung (Green, Yellow, Red) in den Gesamtkontext eingeordnet. Methodik und Bewertungslogik bleiben über den gesamten Ablauf gleich; Umfang und Detailtiefe steigen von Phase zu Phase : von Light über Core bis Deep Dive.",
          deliverablesLabel: "Lieferobjekte",
          deliverablesHeadline: "Was Sie konkret erhalten",
          deliverablesBody: "Klar strukturiert, management- und board-tauglich : verdichtet auf das Wesentliche.",
          dimensionsAlt:
            "Abexis 6 Dimensionen Modell : Strategy, Governance, Execution, Risks, Organisation & Change, Technology & Data",
          ...
          processIntro:
            "Light, Core und Deep Dive sind keine alternativen «Pakete», sondern die aufeinander aufbauenden Stufen desselben Reality Check — von der ersten Einordnung bis zur vertieften Entscheidungs- und Umsetzungsgrundlage. Umfang und Investition klären wir im Erstgespräch; in der Regel als Fixpreis, ohne versteckte Folgekosten.",
          timelineLabel: "Beispielhafter Ablauf : Core Phase",
          timelineAlt:
            "Ablauf Project Reality Check: Tag 1 Kickoff & Dokumentenanalyse, Tag 2-3 Interviews, Tag 4 Analyse & Bewertung, Tag 5 Executive Präsentation",
          phaseLabel: "Phase",
          objectiveLabel: "Ziel",
          contentLabel: "Inhalt",
          outputLabel: "Output",
          alignmentNote:
            "Wir stimmen den genauen Umfang und die Dauer mit Ihnen ab : als durchgängiger Ablauf, nicht als isolierte Bausteine.",
          appointmentCta: "Termin vereinbaren",
          nextStep: "Nächster Schritt",
          finalHeadline: "Lassen Sie uns kurz darauf schauen",
          finalBody:
            "In einem kurzen Gespräch klären wir, ob ein Project Reality Check sinnvoll ist und wo Ihr Projekt aktuell steht : unverbindlich.",
          tags: ["Kostenlos", "Kurzes Gespräch", "Unverbindlich", "Modular"],
          calendarCta: "Online-Kalender öffnen",
        },
      };
  const s = c.strings;
      ...
      <div className="overflow-hidden md:grid md:grid-cols-2">
        ...
        <div className="relative bg-[#1a2260]">
          <div className="relative ml-auto max-w-[534px] px-4 py-12 sm:px-8 sm:py-14 md:px-12 md:py-20">
            ...
            <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-white/55">{s.challengeLabel}</p>
            ...
            <p className="mt-8 text-[11px] font-semibold uppercase tracking-[0.18em] text-white/65">{s.frequentlySeen}</p>
            <ul className="mt-4 flex flex-col gap-3">
              {c.herausforderungBullets.map((item) => (
            ...
            <p className="mt-8 text-[11px] font-semibold uppercase tracking-[0.18em] text-white/65">{s.resultLabel}</p>
            <ul className="mt-4 flex flex-col gap-2">
              {c.ergebnisFolgen.map((item) => (
                <li key={item} className="flex items-start gap-3 text-[15px] text-white/82">
        ...
        <div className="relative bg-[#faf8f2]">
          <div className="relative mr-auto max-w-[534px] px-4 py-12 sm:px-8 sm:py-14 md:px-12 md:py-20">
            ...
            <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[#86868b]">{s.resultLabel}</p>
            <h2 className="mt-3 text-[clamp(1.375rem,3vw+0.5rem,1.875rem)] font-semibold leading-[1.1] tracking-[-0.025em] text-[#1d1d1f]">
              {s.resultHeadline}
            </h2>
            <p className="mt-5 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#86868b]">{s.youReceive}</p>
            <ul className="mt-4 flex flex-col gap-3">
              {c.ergebnisLieferung.map((item) => (
        ...
        <div className="relative mx-auto max-w-[1068px] px-4 py-14 sm:px-6 sm:py-16 md:py-24">
          <div className="grid gap-8 sm:gap-10 lg:grid-cols-[1fr_1.8fr] lg:gap-16">
            <div className="lg:sticky lg:top-28 lg:self-start">
              <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[#86868b]">{s.approachLabel}</p>
        ...
        <div className="relative mx-auto max-w-[1068px] px-4 py-14 sm:px-6 sm:py-16 md:py-24">
          <div className="grid gap-8 sm:gap-10 lg:grid-cols-[minmax(0,320px)_1fr] lg:gap-16 lg:items-start">
            <div className="lg:sticky lg:top-28">
              <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[#86868b]">{s.deliverablesLabel}</p>
              <h2 className="mt-4 text-[clamp(1.625rem,3.5vw+0.5rem,2.375rem)] font-semibold leading-[1.09] tracking-[-0.03em] text-[#1d1d1f]">
                {s.deliverablesHeadline}
              </h2>
              <div className="mt-7 h-px w-full bg-black/[0.06]" />
              <p className="mt-6 text-[15px] leading-relaxed text-[#6e6e73]">
                {s.deliverablesBody}
            ...
            <div className="relative max-w-xl lg:max-w-lg xl:max-w-xl">
              <ol className="relative m-0 flex list-none flex-col gap-3 p-0">
                {c.lieferobjekte.map((item, index) => (
                  <li
                    key={item.id}
        ...
        <MotionSection>
          <div className="relative mx-auto max-w-[1068px] px-4 py-14 sm:px-6 sm:py-16 md:py-28">
            <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1 border-b border-white/10 pb-5 sm:pb-6">
              ...
              <span className="text-[11px] text-white/40">{s.possiblePaths}</span>
            </div>
          ...
          <div className="relative mx-auto max-w-[1068px] px-4 py-14 sm:px-6 sm:py-16 md:py-28">
            ...
            <div className="relative mx-auto mt-10 max-w-3xl sm:mt-14">
              <ol className="relative m-0 flex list-none flex-col gap-6 p-0 sm:gap-8 md:gap-10">
                {c.prcPipelinePhasen.map((phase, index) => {
                  const step = index + 1;
                  return (
                    <li key={phase.name}>
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:gap-4 md:gap-5">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="mt-2 text-[14px] font-medium leading-snug text-[#26337c] sm:mt-3 sm:text-[15px]">
                              {s.objectiveLabel}: {phase.ziel}
                            </p>
                          </div>
                        </div>
                        <div className="mt-5 grid gap-6 sm:mt-6 sm:grid-cols-2 sm:gap-8 md:gap-10">
                          <div>
                            <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#86868b]">{s.contentLabel}</p>
                          ...
                          <div>
                            <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#86868b]">{s.outputLabel}</p>
                            <ul className="mt-3 flex flex-col gap-2.5">
        ...
        <div className="mx-auto max-w-[1068px]">
          <div className="abexis-hero-gradient-surface relative overflow-hidden rounded-[20px] px-4 py-8 sm:rounded-[24px] sm:px-8 sm:py-12 md:rounded-[32px] md:px-12 md:py-16">
            ...
            <div className="relative grid gap-8 md:grid-cols-[1fr_auto] md:items-center md:gap-10">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-white/55">{s.nextStep}</p>
