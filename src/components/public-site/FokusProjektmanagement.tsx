    ...
    <InteriorPageRoot>
      ...
      <PageHero
        ...
        actions={
          <>
            ...
            <Link href="/kontakt" className="inline-flex h-11 items-center gap-2 rounded-full border border-[#26337c]/15 bg-white px-7 text-sm font-semibold text-[#26337c] transition-all hover:border-[#26337c]/30 hover:bg-[#f7f8fc]">
              30-Minuten-Erstgespräch
            </Link>
            <Link href="#handlungsfelder" className="inline-flex h-11 items-center gap-2 rounded-full border border-[#26337c]/20 px-7 text-sm font-semibold text-[#26337c] transition-all hover:border-[#26337c]/40 hover:bg-[#f7f8fc]">
              Handlungsfelder
      ...
      >
        ...
        <h1 className="mt-3 max-w-[22ch] text-[clamp(2.25rem,7vw+0.5rem,3.875rem)] font-semibold leading-[1.04] tracking-[-0.035em] text-white text-balance">
          <HeroHeadlineText>Projekte scheitern selten an der Idee : sie scheitern an der Führung.</HeroHeadlineText>
        </h1>
      </PageHero>
      ...
      {/* ── 2b. LEISTUNG 3 : Externes Risikomanagement ─────────────────── */}
      <MotionSection>
        <div className="relative overflow-hidden bg-[#26337c]">
          <div className="mx-auto max-w-[1068px] px-8 py-14 md:px-12 md:py-20">
            <LCorner className="top-6 left-6 text-[#45b3e2]/30" />
            <div className="mb-6 h-[3px] w-10 rounded-full bg-[#45b3e2]/50" />
            <h2 className="text-[11px] font-semibold uppercase tracking-[0.22em] text-white/45">Leistung 3</h2>
            ...
            <p className="mt-5 max-w-[62ch] text-[16px] leading-relaxed text-white/65">
              Wir begleiten anspruchsvolle Projekte als unabhängiger Risk Manager. Mit einem flexiblen Pensum von etwa 10
              bis 20 Prozent identifizieren und bewerten wir Risiken, verfolgen Massnahmen und schaffen Transparenz für
              Projektleitung, Steuerungsgremium und Geschäftsleitung.
            </p>
            <Link
