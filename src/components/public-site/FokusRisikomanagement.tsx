  ...
  return (
    <InteriorPageRoot>
      ...
      <PageHero
        imageSrc={heroImage}
        priority
        intro={<p>{c.hero.body}</p>}
        actions={
          <>
            <HeroProjectRealityCheckCta href={c.prcPath} />
            <Link href={contactHref} className="inline-flex h-11 items-center gap-2 rounded-full border border-[#26337c]/15 bg-white px-7 text-sm font-semibold text-[#26337c] transition-all hover:border-[#26337c]/30 hover:bg-[#f7f8fc]">
      ...
      >
        ...
        <h1 className="mt-3 max-w-[22ch] text-[clamp(2.25rem,7vw+0.5rem,3.875rem)] font-semibold leading-[1.04] tracking-[-0.035em] text-white text-balance">
          <HeroHeadlineText>{c.hero.title}</HeroHeadlineText>
        </h1>
      </PageHero>
