  ...
  return (
    <InteriorPageRoot>
      ...
      <PageHero
        ...
        intro={
          <p>
            Wenn Verwaltungsrat und Management die Digitalisierung verschieden interpretieren, entstehen
            Fehlinvestitionen, Reibung und verpasste Chancen. Wir helfen Ihnen, aus Technologie echten Unternehmenswert
            zu machen : strukturiert, strategisch, umsetzbar.
          </p>
        }
        actions={
          <>
      ...
      >
        ...
        <h1 className="mt-3 max-w-[22ch] text-[clamp(2.25rem,7vw+0.5rem,3.875rem)] font-semibold leading-[1.04] tracking-[-0.035em] text-white text-balance">
          <HeroHeadlineText>Digitale Transformation ist kein IT-Projekt : sie ist eine Führungsaufgabe.</HeroHeadlineText>
        </h1>
      </PageHero>
