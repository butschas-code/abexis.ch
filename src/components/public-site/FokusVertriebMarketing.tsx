...
export function FokusVertriebMarketing() {
  return (
    <InteriorPageRoot>
      <SchemaMarkup
        type="Service"
        path="/fokusthemen/vertriebmarketing"
        name={meta.title}
        data={meta}
        breadcrumbs={[
          { name: "Startseite", url: "/" },
      ...
      <PageHero
        ...
        intro={
          <p>
            Wenn Vertrieb und Marketing gegeneinander arbeiten, Zielkunden unklar sind und Prozesse vom Zufall
            abhängen, entgehen Ihnen Umsatz und Marktanteile. Wir helfen Ihnen, Struktur, Fokus und Wirkung in Ihre
            Go-to-Market-Aktivitäten zu bringen.
          </p>
        }
        actions={
          <>
      ...
      >
        ...
        <h1 className="mt-3 max-w-[22ch] text-[clamp(2.25rem,7vw+0.5rem,3.875rem)] font-semibold leading-[1.04] tracking-[-0.035em] text-white text-balance">
          <HeroHeadlineText>Vertrieb ohne Strategie ist teures Rauschen.</HeroHeadlineText>
        </h1>
      </PageHero>
