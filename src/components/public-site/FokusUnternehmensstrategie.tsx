  ...
  return (
    <InteriorPageRoot>
      ...
      <PageHero
        ...
        intro={
          <p>
            Wenn Verwaltungsrat und Führungsteam die Zukunft verschieden sehen, braucht es Methodik, Struktur und eine
            externe Perspektive : keinen Kompromiss. Wir begleiten Sie vom ersten Schritt bis zur gelebten Strategie.
          </p>
        }
        actions={
          <>
            ...
            <Link href="#prozess" className="inline-flex h-11 items-center gap-2 rounded-full border border-[#26337c]/20 px-7 text-sm font-semibold text-[#26337c] transition-all hover:border-[#26337c]/40 hover:bg-[#f7f8fc]">
              Zum Prozess
      ...
      >
        ...
        <h1 className="mt-3 max-w-[22ch] text-[clamp(2.25rem,7vw+0.5rem,3.875rem)] font-semibold leading-[1.04] tracking-[-0.035em] text-white text-balance">
          <HeroHeadlineText>Strategie entsteht dort, wo Perspektiven auseinandergehen.</HeroHeadlineText>
        </h1>
      </PageHero>
