...
export function FokusProzessoptimierung() {
  return (
    <InteriorPageRoot>
      <SchemaMarkup
        type="Service"
        path="/fokusthemen/prozessoptimierung"
        name={meta.title}
        data={meta}
        breadcrumbs={[
          { name: "Startseite", url: "/" },
      ...
      <PageHero
        ...
        intro={
          <p>
            Gewachsene Strukturen, ungeklärte Schnittstellen und manuelle Umwege kosten täglich Zeit, Geld und
            Motivation. Wir helfen Ihnen, Prozesse zu durchleuchten, zu straffen und dort zu automatisieren, wo es
      ...
      >
        ...
        <h1 className="mt-3 max-w-[22ch] text-[clamp(2.25rem,7vw+0.5rem,3.875rem)] font-semibold leading-[1.04] tracking-[-0.035em] text-white text-balance">
          <HeroHeadlineText>Wenn Prozesse wachsen, aber nicht atmen : zahlt das Unternehmen dafür.</HeroHeadlineText>
        </h1>
      </PageHero>
