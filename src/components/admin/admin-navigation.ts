...
export const ADMIN_NAV_ITEMS: readonly AdminNavItem[] = [
  ...
  { href: CMS_PATHS.adminBlogAutomation, label: "Blog-Automation", permission: "manage_posts" },
  { href: CMS_PATHS.adminBlogAutomationDrafts, label: "Blog (KI-Entwürfe)", permission: "manage_posts" },
  { href: CMS_PATHS.adminBlogPipelineSocial, label: "Social (KI)", permission: "manage_posts" },
  { href: CMS_PATHS.adminBlogPipelineTopics, label: "Blog-Themen", permission: "manage_posts" },
